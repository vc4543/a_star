...
class SVGPuzzle implements Puzzle {
    ...
    constructor(
        ...
        this.canvasWidth = this.containers.puzzle.width() - 2 * this.wallSeparation;
        this.canvasHeight = this.containers.puzzle.height() - this.floorThickness;
    ...
    public printPuzzle(callback?) {
        this.containers.puzzle.empty();
        this.printSystemOutput("Please wait while I populate the puzzle.")
        ...
        var svg = $(this.SVG('svg')).attr({
            ...
            width: viewBox[2],
            height: viewBox[3],
        }).appendTo(this.containers.puzzle);
